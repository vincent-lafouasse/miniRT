...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   t_partitioned_elements.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: jamar <jamar@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/01 19:31:38 by jamar             #+#    #+#             */
/*   Updated: 2025/04/01 19:31:38 by jamar            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		t_element element)
{
	...
	else if (kind == ELEM_SPHERE_PRIMITIVE || kind == ELEM_PLANE_PRIMITIVE
		|| kind == ELEM_CYLINDER_PRIMITIVE || kind == ELEM_TRIANGLE_PRIMITIVE)
