...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/01 19:15:50 by jamar             #+#    #+#             */
/*   Updated: 2025/04/01 19:15:50 by jamar            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void							el_push_front_link(t_element_list **self,
									t_element_list *link);
t_error							el_push_front(t_element_list **self,
									t_element element);
